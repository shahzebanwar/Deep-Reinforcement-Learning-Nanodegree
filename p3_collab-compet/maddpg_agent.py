...
# source: https://github.com/taimurzahid/Deep-Reinforcement-Learning-Nanodegree/blob/master/p2_continuous-control/ddpg_agent.py
# Recommended by @MSJose on Slack Community
...
OU_SIGMA  = 0.2         # Ornstein-Uhlenbeck noise parameters
OU_THETA  = 0.15        # Ornstein-Uhlenbeck noise parameters
EPSILON       = 5.0     # for epsilon in the noise process (act step)
EPSILON_DECAY = 6e-6    # For the decay of the epsilon over time
...
class Agent():
    ...
    def __init__(self, state_size, action_size, num_agents, random_seed):
        ...
        self.epsilon = EPSILON # Recommended by @MSJose on Slack Community
    ...
    def step(self, state, action, reward, next_state, done, agent_num):
        ...
        # Modifications recommended by @MSJose on Slack Community
